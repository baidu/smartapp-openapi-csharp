...
{
    // 响应类
    public class UpdateOrderSubStatusResponsedataItem : SmartBaseResponse
    {
        /// <summary>
        /// POST 请求参数中 BizAPPID
        /// </summary>
    ...
    public class UpdateOrderSubStatusResponse : SmartBaseResponse
    {
        /// <summary>
        /// 响应对象
        /// </summary>
        [Newtonsoft.Json.JsonProperty("data")]
        public IList<UpdateOrderSubStatusResponsedataItem> Data { get; set; }
    }
    // Post Json
    [DataContract]
    public class UpdateOrderSubStatusPostData {
        /// <summary>
        /// 请求数据
        /// </summary>
        [DataMember]
        [Newtonsoft.Json.JsonProperty("Data")]
        public IList<UpdateOrderSubStatusRequestDataItem> Data { get; set; }
    }
    // JsonRequests
    [DataContract]
    ...
    public class UpdateOrderSubStatusRequestDataItemEXTSubsOrder {
        ...
        public IList<UpdateOrderSubStatusRequestDataItemEXTSubsOrderItemsItem> Items { get; set; }
        /// <summary>
    ...
    public class UpdateOrderSubStatusRequestDataItemEXT {
        ...
        public UpdateOrderSubStatusRequestDataItemEXTSubsOrder SubsOrder { get; set; }
    }
    [DataContract]
    public class UpdateOrderSubStatusRequestDataItem {
        ...
        public UpdateOrderSubStatusRequestDataItemEXT EXT { get; set; }
        /// <summary>
        /// 开发者接入的唯一订单 ID
        /// </summary>
        [DataMember]
    ...
    // 请求类
    public class UpdateOrderSubStatusRequest : OpenApiBaseRequest<UpdateOrderSubStatusResponse>
    {
        public UpdateOrderSubStatusRequest() : base("/rest/2.0/smartapp/ordercenter/app/update/sub/status?sp_sdk_lang=csharp&sp_sdk_ver=1.0.0&access_token={access_token}&open_id={open_id}&scene_id={scene_id}&scene_type={scene_type}&pm_app_key={pm_app_key}", RestSharp.Method.POST)
        {
        }
