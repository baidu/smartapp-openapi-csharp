...
{
    // 响应类
    public class ModifyMaterialResponse : SmartBaseResponse
    {
        /// <summary>
    ...
    // 请求类
    public class ModifyMaterialRequest : OpenApiBaseRequest<ModifyMaterialResponse>
    {
        public ModifyMaterialRequest() : base("/rest/2.0/smartapp/articlemount/material/modify?sp_sdk_lang=csharp&sp_sdk_ver=1.0.0&access_token={access_token}", RestSharp.Method.POST)
        {
        }
