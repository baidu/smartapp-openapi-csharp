...
{
    // 响应类
    public class UpdateOrderSubInfoResponsedataItem : SmartBaseResponse
    {
        /// <summary>
        /// POST 请求参数中 BizAPPID
        /// </summary>
    ...
    public class UpdateOrderSubInfoResponse : SmartBaseResponse
    {
        /// <summary>
        /// 响应对象
        /// </summary>
        [Newtonsoft.Json.JsonProperty("data")]
        public IList<UpdateOrderSubInfoResponsedataItem> Data { get; set; }
    }
    // Post Json
    [DataContract]
    public class UpdateOrderSubInfoPostData {
        /// <summary>
        /// 请求数据
        /// </summary>
        [DataMember]
        [Newtonsoft.Json.JsonProperty("Data")]
        public IList<UpdateOrderSubInfoRequestDataItem> Data { get; set; }
    }
    // JsonRequests
    [DataContract]
    ...
    public class UpdateOrderSubInfoRequestDataItemEXTSubsOrderItemsItemRefund {
        ...
        public IList<UpdateOrderSubInfoRequestDataItemEXTSubsOrderItemsItemRefundProductItem> Product { get; set; }
    }
    [DataContract]
    public class UpdateOrderSubInfoRequestDataItemEXTSubsOrderItemsItem {
        ...
        public UpdateOrderSubInfoRequestDataItemEXTSubsOrderItemsItemOrderDetail OrderDetail { get; set; }
        /// <summary>
        ...
        public UpdateOrderSubInfoRequestDataItemEXTSubsOrderItemsItemRefund Refund { get; set; }
        /// <summary>
        /// 售后订单 ID
        /// </summary>
        [DataMember]
    ...
    public class UpdateOrderSubInfoRequestDataItemEXTSubsOrder {
        ...
        public IList<UpdateOrderSubInfoRequestDataItemEXTSubsOrderItemsItem> Items { get; set; }
        /// <summary>
    ...
    public class UpdateOrderSubInfoRequestDataItemEXT {
        ...
        public UpdateOrderSubInfoRequestDataItemEXTSubsOrder SubsOrder { get; set; }
    }
    [DataContract]
    public class UpdateOrderSubInfoRequestDataItem {
        ...
        public UpdateOrderSubInfoRequestDataItemEXT EXT { get; set; }
        /// <summary>
        /// 开发者接入的唯一订单 ID
        /// </summary>
        [DataMember]
    ...
    // 请求类
    public class UpdateOrderSubInfoRequest : OpenApiBaseRequest<UpdateOrderSubInfoResponse>
    {
        public UpdateOrderSubInfoRequest() : base("/rest/2.0/smartapp/ordercenter/app/update/sub/info?sp_sdk_lang=csharp&sp_sdk_ver=1.0.0&access_token={access_token}&open_id={open_id}&scene_id={scene_id}&scene_type={scene_type}&pm_app_key={pm_app_key}", RestSharp.Method.POST)
        {
        }
