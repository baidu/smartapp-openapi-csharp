...
{
    // 响应类
    public class UpdateOrderStatusResponsedataItem : SmartBaseResponse
    {
        /// <summary>
        /// POST 请求参数中 BizAPPID
        /// </summary>
    ...
    public class UpdateOrderStatusResponse : SmartBaseResponse
    {
        /// <summary>
        /// 响应对象
        /// </summary>
        [Newtonsoft.Json.JsonProperty("data")]
        public IList<UpdateOrderStatusResponsedataItem> Data { get; set; }
    }
    // Post Json
    [DataContract]
    public class UpdateOrderStatusPostData {
        /// <summary>
        /// 请求数据
        /// </summary>
        [DataMember]
        [Newtonsoft.Json.JsonProperty("Data")]
        public IList<UpdateOrderStatusRequestDataItem> Data { get; set; }
    }
    // JsonRequests
    [DataContract]
    ...
    // 请求类
    public class UpdateOrderStatusRequest : OpenApiBaseRequest<UpdateOrderStatusResponse>
    {
        public UpdateOrderStatusRequest() : base("/rest/2.0/smartapp/ordercenter/app/update/main/status?sp_sdk_lang=csharp&sp_sdk_ver=1.0.0&access_token={access_token}&open_id={open_id}&scene_id={scene_id}&scene_type={scene_type}&pm_app_key={pm_app_key}", RestSharp.Method.POST)
        {
        }
