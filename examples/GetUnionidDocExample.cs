...
namespace testSDK
{
    class Program
    {
        ...
        {
            var request = new GetUnionidRequest() {};
            // 开发者在此设置请求参数，文档示例中的参数均为示例参数，实际参数请参考对应接口的文档上方的参数说明填写
            // 注意：代码示例中的参数字段基本是驼峰形式，而文档中的参数说明的参数字段基本是下划线形式
            // 如果开发者不想传非必需参数，可以将设置该参数的行注释
            request.AccessToken = "25.661f86520a3515a2c5ad0c761623eb13.7243315.7561772157.624723-66665682"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
            // Post Form
            request.Openid = "k11HEREQhWhWWB6WYqYT1ITUGX"; // 文档中对应字段：openid，实际使用时请替换成真实参数

            

            Task task = TestGetUnionidRequest(request);
            task.Wait();
        }

        public static async Task TestGetUnionidRequest(GetUnionidRequest request)
        {
            try {
