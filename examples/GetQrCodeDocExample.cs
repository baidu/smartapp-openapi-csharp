...
namespace testSDK
{
    class Program
    {
        ...
        {
            var request = new GetQrCodeRequest() {};
            // 开发者在此设置请求参数，文档示例中的参数均为示例参数，实际参数请参考对应接口的文档上方的参数说明填写
            // 注意：代码示例中的参数字段基本是驼峰形式，而文档中的参数说明的参数字段基本是下划线形式
            // 如果开发者不想传非必需参数，可以将设置该参数的行注释
            request.AccessToken = "26.584f85117a6558a0c3ad7c726164eb50.1561343.8333125766.144132-08046002"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
            // Post Form
            request.Path = "pages/index/index"; // 文档中对应字段：path，实际使用时请替换成真实参数
            request.Width = 542; // 文档中对应字段：width，实际使用时请替换成真实参数
            request.Mf = 0; // 文档中对应字段：mf，实际使用时请替换成真实参数
            request.ImgFlag = 1; // 文档中对应字段：img_flag，实际使用时请替换成真实参数

            

            Task task = TestGetQrCodeRequest(request);
            task.Wait();
        }

        public static async Task TestGetQrCodeRequest(GetQrCodeRequest request)
        {
            try {
