...
namespace testSDK
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            request.AccessToken = "24.4fa833ebfa5c878dda4b2a020c16758e.6871638.5724313481.006383-57164787"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
            // Post Form
            request.ID = "BD1548"; // 文档中对应字段：id，实际使用时请替换成真实参数
            request.KeywordIDList = "[7,1,7]"; // 文档中对应字段：keyword_id_list，实际使用时请替换成真实参数

            

            Task task = TestAddTemplateRequest(request);
            task.Wait();
        }

        public static async Task TestAddTemplateRequest(AddTemplateRequest request)
        {
            try {
