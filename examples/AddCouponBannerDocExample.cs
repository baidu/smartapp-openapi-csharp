...
namespace testSDK
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            request.AccessToken = "24.262f05844a7423a6c1ad5c265342eb83.1244588.3225511027.776587-48313270"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
            ...
            AddCouponBannerPostData postData = new AddCouponBannerPostData {
                ...
                CouponID = "8684021248", // 文档中对应字段：couponId，实际使用时请替换成真实参数
            ...
            Task task = TestAddCouponBannerRequest(request);
            task.Wait();
        }

        public static async Task TestAddCouponBannerRequest(AddCouponBannerRequest request)
        {
            try {
