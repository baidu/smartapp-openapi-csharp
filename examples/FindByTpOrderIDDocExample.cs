...
namespace testSDK
{
    class Program
    {
        ...
        {
            var request = new FindByTpOrderIDRequest() {};
            // 开发者在此设置请求参数，文档示例中的参数均为示例参数，实际参数请参考对应接口的文档上方的参数说明填写
            // 注意：代码示例中的参数字段基本是驼峰形式，而文档中的参数说明的参数字段基本是下划线形式
            // 如果开发者不想传非必需参数，可以将设置该参数的行注释
            request.AccessToken = "24.400c6780c78c20668d4efd7f8522ebd8.2477124.3372404660.666730-83844035"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
            request.TpOrderID = "1107350334758"; // 文档中对应字段：tpOrderId，实际使用时请替换成真实参数
            request.PmAppKey = "MMUpGO"; // 文档中对应字段：pmAppKey，实际使用时请替换成真实参数

            

            Task task = TestFindByTpOrderIDRequest(request);
            task.Wait();
        }

        public static async Task TestFindByTpOrderIDRequest(FindByTpOrderIDRequest request)
        {
            try {
