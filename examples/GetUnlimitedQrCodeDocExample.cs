...
namespace testSDK
{
    class Program
    {
        ...
        {
            var request = new GetUnlimitedQrCodeRequest() {};
            // 开发者在此设置请求参数，文档示例中的参数均为示例参数，实际参数请参考对应接口的文档上方的参数说明填写
            // 注意：代码示例中的参数字段基本是驼峰形式，而文档中的参数说明的参数字段基本是下划线形式
            // 如果开发者不想传非必需参数，可以将设置该参数的行注释
            request.AccessToken = "22.318f20781a0676a1c1ad0c032253eb36.1410657.0666278820.556314-05420620"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
            // Post Form
            request.Path = "pages/index/index"; // 文档中对应字段：path，实际使用时请替换成真实参数
            request.Width = 557; // 文档中对应字段：width，实际使用时请替换成真实参数
            request.Mf = 0; // 文档中对应字段：mf，实际使用时请替换成真实参数
            request.ImgFlag = 1; // 文档中对应字段：img_flag，实际使用时请替换成真实参数

            

            Task task = TestGetUnlimitedQrCodeRequest(request);
            task.Wait();
        }

        public static async Task TestGetUnlimitedQrCodeRequest(GetUnlimitedQrCodeRequest request)
        {
            try {
