...
namespace testSDK
{
    class Program
    {
        ...
        {
            var request = new UpdateCouponBannerRequest() {};
            // 开发者在此设置请求参数，文档示例中的参数均为示例参数，实际参数请参考对应接口的文档上方的参数说明填写
            // 注意：代码示例中的参数字段基本是驼峰形式，而文档中的参数说明的参数字段基本是下划线形式
            // 如果开发者不想传非必需参数，可以将设置该参数的行注释
            request.AccessToken = "26.702f44386a3213a8c8ad4c078105eb66.2800141.0867212532.104851-63081118"; // 文档中对应字段：access_token，实际使用时请替换成真实参数

            
            
            // PostRequests
            UpdateCouponBannerPostData postData = new UpdateCouponBannerPostData {
                CouponID = "8826540514", // 文档中对应字段：couponId，实际使用时请替换成真实参数
                PicURL = "https://mbs0.bdstatic.com/searchbox/mappconsole/image/76557608/3f5c0a5b-fe0e-8448-b21b-0a4f44e55f35.png", // 文档中对应字段：picUrl，实际使用时请替换成真实参数
            ...
            Task task = TestUpdateCouponBannerRequest(request);
            task.Wait();
        }

        public static async Task TestUpdateCouponBannerRequest(UpdateCouponBannerRequest request)
        {
            try {
