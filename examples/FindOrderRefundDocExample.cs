...
namespace testSDK
{
    class Program
    {
        ...
        {
            var request = new FindOrderRefundRequest() {};
            // 开发者在此设置请求参数，文档示例中的参数均为示例参数，实际参数请参考对应接口的文档上方的参数说明填写
            // 注意：代码示例中的参数字段基本是驼峰形式，而文档中的参数说明的参数字段基本是下划线形式
            // 如果开发者不想传非必需参数，可以将设置该参数的行注释
            request.AccessToken = "21.613c4648c32c15336d8efd6f0061ebd1.8202350.3804363384.381232-08686374"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
            request.TpOrderID = "1777824433130"; // 文档中对应字段：tpOrderId，实际使用时请替换成真实参数
            request.UserID = 1063680; // 文档中对应字段：userId，实际使用时请替换成真实参数
            request.PmAppKey = "MMUpGO"; // 文档中对应字段：pmAppKey，实际使用时请替换成真实参数

            

            Task task = TestFindOrderRefundRequest(request);
            task.Wait();
        }

        public static async Task TestFindOrderRefundRequest(FindOrderRefundRequest request)
        {
            try {
