...
namespace testSDK
{
    class Program
    {
        ...
        {
            var request = new BatchGetCouponBannerRequest() {};
            // 开发者在此设置请求参数，文档示例中的参数均为示例参数，实际参数请参考对应接口的文档上方的参数说明填写
            // 注意：代码示例中的参数字段基本是驼峰形式，而文档中的参数说明的参数字段基本是下划线形式
            // 如果开发者不想传非必需参数，可以将设置该参数的行注释
            request.AccessToken = "27.830f18582a2074a1c2ad5c008087eb14.8246416.1278358761.661613-27611860"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
            request.CouponID = "8775202606"; // 文档中对应字段：couponId，实际使用时请替换成真实参数

            

            Task task = TestBatchGetCouponBannerRequest(request);
            task.Wait();
        }

        public static async Task TestBatchGetCouponBannerRequest(BatchGetCouponBannerRequest request)
        {
            try {
