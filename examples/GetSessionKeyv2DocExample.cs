...
namespace testSDK
{
    class Program
    {
        ...
        {
            var request = new GetSessionKeyv2Request() {};
            // 开发者在此设置请求参数，文档示例中的参数均为示例参数，实际参数请参考对应接口的文档上方的参数说明填写
            // 注意：代码示例中的参数字段基本是驼峰形式，而文档中的参数说明的参数字段基本是下划线形式
            // 如果开发者不想传非必需参数，可以将设置该参数的行注释
            request.AccessToken = "27.147f23346a2757a7c3ad5c300338eb63.0432241.6375411467.356780-53256837"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
            request.Code = "2dc6c426b57552a4707560c28227db66NW"; // 文档中对应字段：code，实际使用时请替换成真实参数

            

            Task task = TestGetSessionKeyv2Request(request);
            task.Wait();
        }

        public static async Task TestGetSessionKeyv2Request(GetSessionKeyv2Request request)
        {
            try {
