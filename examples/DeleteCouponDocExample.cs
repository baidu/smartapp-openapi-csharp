...
namespace testSDK
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            request.AccessToken = "21.565f15716a3302a5c7ad4c825785eb37.3134018.3708745041.806645-60740828"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
            // Post Form
            request.CouponID = "8142048257"; // 文档中对应字段：couponId，实际使用时请替换成真实参数

            

            Task task = TestDeleteCouponRequest(request);
            task.Wait();
        }

        public static async Task TestDeleteCouponRequest(DeleteCouponRequest request)
        {
            try {
