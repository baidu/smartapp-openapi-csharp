...
namespace testSDK
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            request.AccessToken = "23.081f41577a7081a2c5ad4c348652eb35.1726783.8310060385.473317-62701648"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
            request.CouponID = "8645566144"; // 文档中对应字段：couponId，实际使用时请替换成真实参数

            

            Task task = TestGetCouponRequest(request);
            task.Wait();
        }

        public static async Task TestGetCouponRequest(GetCouponRequest request)
        {
            try {
