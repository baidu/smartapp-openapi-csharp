...
namespace testSDK
{
    class Program
    {
        ...
        {
            var request = new GetLikeCountRequest() {};
            // 开发者在此设置请求参数，文档示例中的参数均为示例参数，实际参数请参考对应接口的文档上方的参数说明填写
            // 注意：代码示例中的参数字段基本是驼峰形式，而文档中的参数说明的参数字段基本是下划线形式
            // 如果开发者不想传非必需参数，可以将设置该参数的行注释
            request.AccessToken = "27.8e410258ce352eb6bf05c111af07ac87.4606567.8226063338.845583-72167813"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
            request.HostName = "baiduboxapp"; // 文档中对应字段：host_name，实际使用时请替换成真实参数
            // Post Form
            request.Snid = "ts_article_c765ed8e26ce04467f8067eb"; // 文档中对应字段：snid，实际使用时请替换成真实参数
            request.SnidType = ""; // 文档中对应字段：snid_type，实际使用时请替换成真实参数

            

            Task task = TestGetLikeCountRequest(request);
            task.Wait();
        }

        public static async Task TestGetLikeCountRequest(GetLikeCountRequest request)
        {
            try {
