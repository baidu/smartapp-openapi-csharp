...
namespace testSDK
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            request.AccessToken = "28.166f60770a5383a6c7ad8c572462eb11.3407442.8706857407.283707-71054778"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
            // Post Form
            request.TemplateID = "9fe1d66bb4b157686ea1e36f47100a31"; // 文档中对应字段：template_id，实际使用时请替换成真实参数

            

            Task task = TestDeleteTemplateRequest(request);
            task.Wait();
        }

        public static async Task TestDeleteTemplateRequest(DeleteTemplateRequest request)
        {
            try {
