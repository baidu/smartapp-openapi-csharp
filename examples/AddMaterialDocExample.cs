...
namespace testSDK
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            request.AccessToken = "22.3fa144ebfa5c036dda6b6a313c50317e.0433756.8102867042.372530-17057518"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
            // Post Form
            request.AppID = 13468830; // 文档中对应字段：app_id，实际使用时请替换成真实参数
            request.ImageURL = "https://mbs6.bdstatic.com/searchbox/mappconsole/image/08334160/d74d1086-abf3-5d73-a3c5-df4e2b18152b.png"; // 文档中对应字段：imageUrl，实际使用时请替换成真实参数
            request.Title = "测试数据"; // 文档中对应字段：title，实际使用时请替换成真实参数
            request.Path = "/pages/index/index"; // 文档中对应字段：path，实际使用时请替换成真实参数
            request.Category1Code = "7"; // 文档中对应字段：category1Code，实际使用时请替换成真实参数
            request.Category2Code = "74157"; // 文档中对应字段：category2Code，实际使用时请替换成真实参数
            ...
            Task task = TestAddMaterialRequest(request);
            task.Wait();
        }

        public static async Task TestAddMaterialRequest(AddMaterialRequest request)
        {
            try {
