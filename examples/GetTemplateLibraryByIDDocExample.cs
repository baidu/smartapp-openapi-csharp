...
namespace testSDK
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            request.AccessToken = "26.2fa162ebfa6c606dda5b5a447c60154e.4348888.0613728748.182568-36721301"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
            request.ID = "BD0361"; // 文档中对应字段：id，实际使用时请替换成真实参数

            

            Task task = TestGetTemplateLibraryByIDRequest(request);
            task.Wait();
        }

        public static async Task TestGetTemplateLibraryByIDRequest(GetTemplateLibraryByIDRequest request)
        {
            try {
